...
import Endereco from '../../app/domain/Endereco'
@Component({
  selector: 'app-confirmacao-do-pedido',
  templateUrl: './confirmacao-do-pedido.page.html',
  styleUrls: ['./confirmacao-do-pedido.page.scss'],
})
export class ConfirmacaoDoPedidoPage implements OnInit {
